...
# commad-line args:
test $# -lt 3 && {
   echo "usage: $0 fastq_path contigs_path threads"
   echo "e.g. $0 /work/m4b_binning/assembly/data/HOW10/8777.1.112183.AATAGG.fastq.gz /work/m4b_binning/assembly/longer_contigs/contigs_longer_than_1500bp.fa 4"
   exit
}
